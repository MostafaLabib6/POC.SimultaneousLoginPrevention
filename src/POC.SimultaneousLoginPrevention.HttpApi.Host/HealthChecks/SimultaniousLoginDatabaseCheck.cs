...
public class SimultaniousLoginDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public SimultaniousLoginDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
